...
*/	
	...
	if (mysqli_connect_error()){
		...
		$sql = "INSERT INTO survey (surname, firstName, contactNumber, date_d, age, typeOfFood, eatOut, movies, watchTv,
        listenRadio)
				VALUES ('$surname', '$firstName', '$contactNumber', '$date_d', '$age', '$check1', '$eatOut', '$movies', '$watchTv',
        '$listenRadio')";
...
/*
        ...
        echo "eat out should not be empty";
    die();
  }
}
